...
use Exception;
use samples\src\com\zoho\crm\api\record\absoluteFilePath;
use samples\src\com\zoho\crm\api\record\DateTime;
use samples\src\com\zoho\crm\api\record\destinationFolder;
use samples\src\com\zoho\crm\api\record\externalFieldValue;
use samples\src\com\zoho\crm\api\record\jobId;
...
class Record
{
	...
	public static function getRecordUsingExternalId(string $moduleAPIName, string $externalFieldValue, string $destinationFolder)
	{
		//example
		//$moduleAPIName = "Leads";
		//$externalFieldValue = "34770615177002";
	...
	public static function deleteRecordUsingExternalId(string $moduleAPIName, string $externalFieldValue)
	{
		...
		//Call deleteRecord method that takes paramInstance, ModuleAPIName and recordId as parameter.
		$response = $recordOperations->deleteRecord($externalFieldValue, $moduleAPIName, $paramInstance, $headerInstance);
	...
	public static function getRecords(string $moduleAPIName)
	{
		...
		$ids = array("TestExternal12", "TestExternal1");
	...
	public static function createRecords(string $moduleAPIName)
	{
		...
		$dealName->addFieldValue(Deals::id(), "34770610207275");
		...
		$record1->addKeyValue("Email", "abc4@zoho.com");
	...
	public static function upsertRecords(string $moduleAPIName)
	{
		...
		$record2->addKeyValue("External", "TestExternal12");
		...
		//Call upsertRecords method that takes BodyWrapper instance as parameter.
	...
	public static function searchRecords(string $moduleAPIName)
	{
		...
		$paramInstance->add(SearchRecordsParam::criteria(), "(External:in:TestExternal12)");
	 ...
	 * @param string $moduleAPIName - The API Name of the module to obtain records.
	 * @throws Exception
	 */
