<?php
namespace Zoho\Sample;

use Zoho\Crm\Util\ModuleFieldsHandler;
use Zoho\Sample\Crm\Api\Attachment;
use Zoho\Sample\Crm\Api\BluePrint;
use Zoho\Sample\Crm\Api\BulkRead;
use Zoho\Sample\Crm\Api\BulkWrite;
use Zoho\Sample\Crm\Api\ContactRoles;
use Zoho\Sample\Crm\Api\Currency;
use Zoho\Sample\Crm\Api\CustomView;
use Zoho\Sample\Crm\Api\Fields;
use Zoho\Sample\Crm\Api\File;
use Zoho\Sample\Crm\Api\Initialize;
use Zoho\Sample\Crm\Api\Layout;
use Zoho\Sample\Crm\Api\Modules;
use Zoho\Sample\Crm\Api\Note;
use Zoho\Sample\Crm\Api\Notification;
use Zoho\Sample\Crm\Api\Organization;
use Zoho\Sample\Crm\Api\Profile;
use Zoho\Sample\Crm\Api\Query;
use Zoho\Sample\Crm\Api\Record;
use Zoho\Sample\Crm\Api\RelatedList;
use Zoho\Sample\Crm\Api\RelatedRecords;
use Zoho\Sample\Crm\Api\Role;
use Zoho\Sample\Crm\Api\ShareRecords;
use Zoho\Sample\Crm\Api\Tag;
use Zoho\Sample\Crm\Api\Tax;
use Zoho\Sample\Crm\Api\Territory;
use Zoho\Sample\Crm\Api\User;
use Zoho\Sample\Crm\Api\Variable;
use Zoho\Sample\Crm\Api\VariableGroup;
