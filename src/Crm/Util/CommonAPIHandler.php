...
class CommonAPIHandler
{
     ...
     * @return \Zoho\Crm\Util\APIResponse A APIResponse representing the Zoho CRM API response instance or null.
     */
     ...
     * @return NULL|\Zoho\Crm\Util\Converter A Converter class instance.
     */
